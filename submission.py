...
orderItemsData = pd.read_csv("https://github.com/andreanovr/BelajarAnalisisDataStreamlit/blob/main/data/order_items_dataset.csv", delimiter=",", lineterminator='\n')
orderPaymentsData = pd.read_csv("https://github.com/andreanovr/BelajarAnalisisDataStreamlit/blob/main/data/order_payments_dataset.csv", delimiter=",", lineterminator='\n')
productsData = pd.read_csv("https://github.com/andreanovr/BelajarAnalisisDataStreamlit/blob/main/data/products_dataset.csv", delimiter=",", lineterminator='\n')
...
secondTopProduct = newdf[(newdf.product_id == "f71f42e2381752836563b70beb542f80")].count()
secondTopProductFix = secondTopProduct["order_item_id"]
thirdTopProduct = newdf[(newdf.product_id == "28bdd20184e553872bab0ae75bbcaecf")].count()
